from flight.predictor import ModelResolver
...
class ModelEvaluation:
    ...
    def __init__(self,
        ...
        data_clean_artifact:artifact_entity.DataCleanArtifact     
        ):
        try:
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluationArtifact:
        try:
            ...
            previous_transformer = load_object(file_path=transformer_path)
            previous_model = load_object(file_path=model_path)
            

            logging.info("Currently trained model objects")
            #Currently trained model objects
            current_transformer = load_object(file_path=self.data_transformation_artifact.transformer_obj)
            ...
            input_feature_name = list(previous_transformer.feature_names_in_)
            input_arr =previous_transformer.transform(test_df[input_feature_name])
            y_pred = previous_model.predict(input_arr)
