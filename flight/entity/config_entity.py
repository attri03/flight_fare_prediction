...
class ModelPusherConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.pusher_model_path = os.path.join(self.pusher_model_dir,MODEL_OBJ)
        self.pusher_transformer_path = os.path.join(self.pusher_model_dir,TRANSFORMER_OBJ_FILE)